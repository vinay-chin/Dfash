...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\chvin\OneDrive\Desktop\vinay\Peer Project\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\chvin\OneDrive\Desktop\vinay\Peer Project\env\Scripts\deactivate.nu'
